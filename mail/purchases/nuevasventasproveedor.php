                    ...
                    <th bgcolor="#fcfbfa" width="600" height="130">
                        ...
                        <center>
                            <h1 style="font-family: Arial; font-size: 22px; font-style: normal; font-weight: 700; line-height: 25px; letter-spacing: 0.05em; text-align: center; color: #383838;">
                                ¡<?= $providerName ?>, nueva venta realizada!</h1>
                            <br>
                            <br>
                            <img src="<?= $imageUrl ?>ilus-tupedido.png" alt="tu-pedido"
                                 style="width: 161px; height: 167px;">
                            <br>
                            <br>
                            <p style="font-family: Arial;font-size: 16px;font-style: normal;font-weight: 100;line-height: 21px;letter-spacing: 0px;text-align: center; width: 420px; color: #383838;">
                                ¡Muy bien! Hiciste nuevas ventas. Empacalas y preparalas <br>para que el cliente las
                                reciba a tiempo.
                            </p>
                            <br>
                            <div style="border: 1px solid #DADADA; width: 524px;">
                                <table bgcolor="white" width="524" height="auto" cellpadding="0" cellspacing="0"
                                       border="0" style="margin: 0 auto; display:block;">
                                    <tr>
                                        <th height="141" width="3"></th>
                                        <th height="141" width="125">
                                            <img src="<?= $purchase->product->getPrincipalImage() ?>"
                                                 alt="imagen-producto" style="width: 124px; height: 124px;">
                                        </th>
                                        <th height="141" width="259">
                                            <p style="color: #383838; font-family: Arial; font-size: 16px; font-style: normal; font-weight: 400; line-height: 20px; letter-spacing: 0em; text-align: left; margin-top: -5px;"><?= substr($purchase->product->name, 0, 51) ?>
                                                ...</p>
                                            <p style="color: #383838; font-family: Arial; font-size: 18px; font-style: normal; font-weight: 700; line-height: 12px; letter-spacing: 0px; text-align: left;">
                                                $<?= number_format($purchase->product->price, 2) ?>
                                                x <?= $purchase->quantity ?>u</p>
                                            <p style="color: #818A91; font-family: Arial; font-size: 14px; font-style: normal; font-weight: 400; line-height: 0px; letter-spacing: 0em; text-align: left;">
                                                Cliente <?= $purchase->client->name . ' ' . $purchase->client->lastname ?></p>
                                        </th>
                                        <th height="141" width="152"><a href=<?=$_ENV['FRONT']?> style="text-decoration: none;"><img
                                                        src="<?= $imageUrl ?>boton-revisar.png" alt="revisar-compra"
                                                        style="width: 168px; height: 55px; margin-top: 10px;"></a></th>
                                        <th height="141" width="3"></th>
                                    </tr>
                                </table>
                            </div>
