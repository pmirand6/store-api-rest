            ...
            <td>
                <table width="600" height="auto" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; display:block;">
                    <th bgcolor="#fcfbfa" width="600" height="130">
                        ...
                        <center>
                            <h1 style="font-family: Arial; font-size: 22px; font-style: normal; font-weight: 700; line-height: 25px; letter-spacing: 0.05em; text-align: center; color: #383838;">Tu pedido está disponible en modalidad <br><span style="color: #00C3AC;"></strong>Take Away</span></h1>
                            <br>
                            <img src="<?= $imageUrl ?>linea.png" alt="linea" style="width: 420px; height: 1px;">
                            <br>
                            <p style="font-family: Arial, Helvetica, sans-serif; color: #383838; width: 420px; font-size: 16px; font-style: normal; font-weight: 400; line-height: 21px; letter-spacing: 0px; text-align: center; "><?= $purchase->client->name .' '. $purchase->client->lastname ?>, te informamos que tu pedido <strong>ya se encuentra <br> en el domicilio del vendedor</strong>, tal como lo indicaste en el <br> proceso de compra.</p>
                                            ...
                                            <tr>
                                                <td style="width: 50%">
                                                    <p style="text-align: left; padding: 0 20px;">
                                                        <img src="<?= $imageUrl ?>check.png" alt="check" style="width: 11px; height: 9px; margin-right: 5px;"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 700; line-height: 17px; letter-spacing: 0em; text-align: left; color: #00C3AC;">Dirección del vendedor</span><br>
                                                    </p>
                                                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 400; line-height: 17px; letter-spacing: 0em; text-align: left; color: #818A91; margin-left: 35px; margin-top: -10px;"><?= $purchase->product->providers->formatted_address ?></p>
                                                </td>
                                                <td style="width: 50%">
                                                    <p style="text-align: left; padding: 0 20px; ">
                                                    ...
                                                    <p style="padding-right: 10px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 400; line-height: 17px; letter-spacing: 0em; text-align: left; color: #818A91; margin-left: 35px; margin-top: -10px;">-</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td colspan="3" style="padding: 10px 0;">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 50%">
                                                    <p style="text-align: left; padding: 0 20px;">
                                                        <img src="<?= $imageUrl ?>check.png" alt="check" style="width: 11px; height: 9px; margin-right: 5px;"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 700; line-height: 17px; letter-spacing: 0em; text-align: left; color: #00C3AC;">Teléfono</span><br>
                                                    </p>
                                                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 400; line-height: 17px; letter-spacing: 0em; text-align: left; color: #818A91; margin-left: 35px; margin-top: -10px;"><?= $purchase->product->providers->phone_number ?></p>
                                                </td>
                                                <td style="width: 50%">
                                                    <p style="text-align: left; padding: 0 20px; ">
                                                    ...
                                                    <p style="padding-right: 10px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-weight: 400; line-height: 17px; letter-spacing: 0em; text-align: left; color: #818A91; margin-left: 35px; margin-top: -10px;"><?= $purchase->product->providers->email ?></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
