            ...
            <td>
                <table width="600" height="auto" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; display:block;">
                    <th bgcolor="#fcfbfa" width="600" height="130">
                        ...
                        <center>
                            <h1 style="font-family: Arial; font-size: 22px; font-style: normal; font-weight: 700; line-height: 25px; letter-spacing: 0.05em; text-align: center; color: #383838;">¡<?= $purchase->client->name ?>, tu pedido ya fue entregado!</h1>
                            <br>
                            <br>
                            <img src="<?= $imageUrl ?>ilus-tupedido.png" alt="tu-pedido" style="width: 161px; height: 167px;">
                            <br>
                            <br>
                            <p style="font-family: Arial;font-size: 16px;font-style: normal;font-weight: 100;line-height: 21px;letter-spacing: 0px;text-align: center; width: 420px; color: #383838;">¡Gracias por tu compra! Te recordamos que tu pedido <strong>número <?= strtoupper($purchase->shipping_code) ?></strong> se ha entregado en el día de la fecha.</p>
                                ...
                                <table bgcolor="white" width="524" height="auto" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; display:block;">
                                    <tr>
                                        ...
                                        <th height="141" width="259">
                                            ...
                                            <p style="color: #818A91; font-family: Arial; font-size: 14px; font-style: normal; font-weight: 400; line-height: 0px; letter-spacing: 0em; text-align: left;">Entrega <?= $entrega ?></p>
                                        </th>
                                        <th height="141" width="152"><a href="#" style="text-decoration: none;"><img src="<?= $imageUrl ?>boton-calificarcompra.png" alt="calificar-compra" style="width: 168px; height: 55px; margin-top: 10px;"></a></th>
                                        <th height="141" width="3"></th>
                                    </tr>
                                </table>
                            </div>
