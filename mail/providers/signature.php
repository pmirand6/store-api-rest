            ...
            <td>
                <table width="600" height="auto" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; display:block;">
                    <th bgcolor="#fcfbfa" width="600" height="130">
                        ...
                        <center>
                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 22px; font-style: normal; font-weight: 700; line-height: 25px; letter-spacing: 0.05em; text-align: center; color: #373A3C;">
                                <span style="color: #00C3AC;">feriame.com</span><br>
                                T&eacute;rminos y condiciones de feriame
                            </p>
                            <br>
                            <img src="<?= $imageUrl ?>ilus-tyc.png" alt="imagen-producto" style="width: 345px; height: 200px;">
                            <br>
                            <br>
                            <p style="width: 420px; color: #383838; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-style: normal; font-weight: 400; line-height: 21px; letter-spacing: 0px; text-align: left; ">
                                <strong><?= $provider->name ?></strong>, te enviamos una copia de los términos y condiciones que has aceptado para ser parte de feriame.
                                <br>
                                <br>
                                Entre todos, la comunidad feriame, sigue creciendo. Nos alegra contar contigo, hay muchos consumidores que esperan tus productos.
                            </p>
                            <br>
        ...
        <tr>
            <td bgcolor="#00c3ac">
                <center>
                    ...
                    <a href="#" style="text-decoration: none;"><img src="<?= $imageUrl ?>footer-fb.png" style="width: 26px; height: 26px;" alt="facebook"></a>
                    <a href="#" style="text-decoration: none;"><img src="<?= $imageUrl ?>footer-ig.png" style="width: 26px; height: 26px; margin-left: 5px; margin-right: 5px;" alt="instagram"></a>
                    <a href="#" style="text-decoration: none;"><img src="<?= $imageUrl ?>footer-tw.png" style="width: 26px; height: 26px;" alt="twitter"></a>
                    <br>
                    <br>
                    <br>
                </center>
