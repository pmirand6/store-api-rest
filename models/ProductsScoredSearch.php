...
/**
 * ProductsScoredSearch represents the model behind the search form of `app\models\Products`.
 */
class ProductsScoredSearch extends ProductsScored
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = $this->find()->alias('products')->joinWith([
            'productTypes',
            'subproductTypes',
