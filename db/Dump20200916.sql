...
CREATE TABLE `provider_contacts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `provider_contacts_providers_id_foreign` (`providers_id`),
...
CREATE TABLE `provider_deliveries` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `provider_deliveries_providers_id_foreign` (`providers_id`),
...
CREATE TABLE `provider_statuses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `provider_statuses_providers_id_foreign` (`providers_id`),
...
CREATE TABLE `provider_taxes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `provider_taxes_providers_id_foreign` (`providers_id`),
...
-- Dump completed on 2020-09-16 16:44:54
