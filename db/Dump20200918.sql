...
CREATE TABLE `product_media` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mediaproduct_idx` (`products_id`),
  CONSTRAINT `fk_mediaproduct` FOREIGN KEY (`products_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `product_media` VALUES (10,1,1,'2020-09-18 19:45:27',NULL,'[{\"type\":\"image\",\"name\":\"..\\/web\\/uploads\\/product\\/1\\/default.png949054206\"},{\"type\":\"image\",\"name\":\"..\\/web\\/uploads\\/product\\/1\\/img.webp355126022\"},{\"type\":\"video\",\"name\":\"Peter\"},{\"type\":\"video\",\"name\":\"Ben\"},{\"type\":\"video\",\"name\":\"pepee\"}]'),(11,1,2,'2020-09-18 19:45:37',NULL,'[{\"type\":\"image\",\"name\":\"..\\/web\\/uploads\\/product\\/2\\/default.png1040360671\"},{\"type\":\"image\",\"name\":\"..\\/web\\/uploads\\/product\\/2\\/img.webp1921989947\"},{\"type\":\"video\",\"name\":\"Peter\"},{\"type\":\"video\",\"name\":\"Ben\"},{\"type\":\"video\",\"name\":\"pepee\"}]');
...
-- Dump completed on 2020-09-18 16:47:08
